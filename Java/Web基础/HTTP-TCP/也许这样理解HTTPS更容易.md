...
原 来，我漏掉了一个场景：第三方机构不可能只给你一家公司制作证书，它也可能会给中间人这样有坏心思的公司发放证书。这样的，中间人就有机会对你的证书进行 调包，客户端在这种情况下是无法分辨出是接收的是你的证书，还是中间人的。因为不论中间人，还是你的证书，都能使用第三方机构的公钥进行解密。像下面这 样：
...
我 们从现实中找灵感。比如你是HR，你手上拿到候选人的学历证书，证书上写了持证人，颁发机构，颁发时间等等，同时证书上，还写有一个最重要的：证书编号！ 我们怎么鉴别这张证书是的真伪呢？只要拿着这个证书编号上相关机构去查，如果证书上的持证人与现实的这个候选人一致，同时证书编号也能对应上，那么就说明 这个证书是真实的。
...
HTTPS 要使客户端与服务器端的通信过程得到安全保证，必须使用的对称加密算法，但是协商对称加密算法的过程，需要使用非对称加密算法来保证安全，然而直接使用非 对称加密的过程本身也不安全，会有中间人篡改公钥的可能性，所以客户端与服务器不直接使用公钥，而是使用数字证书签发机构颁发的证书来保证非对称加密过程 本身的安全。这样通过这些机制协商出一个对称加密算法，就此双方使用该算法进行加密解密。从而解决了客户端与服务器端之间的通信安全问题。
...
**![](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg== "金属质感分割线")**

**你或许还想看**

[你眼中的Linux高手，都应该读过这几本书！](http://mp.weixin.qq.com/s?__biz=MjM5NTY1MjY0MQ==&mid=2650738758&idx=1&sn=cd63f228f0b87dc61fab73d61c16ad2a&chksm=befe850889890c1e354ce67df0f8ff5c6b9e75c328662d1206391b30636ebe18975241923e19&scene=21#wechat_redirect)

[周鸿祎谈程序员创业，条条都是中肯建议](http://mp.weixin.qq.com/s?__biz=MjM5NTY1MjY0MQ==&mid=2650737944&idx=1&sn=4f59ea782f43ccba07e1a179fe4187ba&chksm=befe9856898911407b80b3cff790b36ef369116e2d09c95e2d743d1ee35ce7dab3a4ab9cd454&scene=21#wechat_redirect)

[代码我只服雷布斯！分享雷军22年前写的代码](http://mp.weixin.qq.com/s?__biz=MjM5NTY1MjY0MQ==&mid=2650737475&idx=1&sn=d6cda758353475aff119528bf7fd8715&chksm=befe9e0d8989171b0995d53a35c13116d8485ed1b69a61a7cfb7845a7b5c4a104bb6da0eb0c9&scene=21#wechat_redirect)

[揭秘：一线互联网薪资曝光，看看你的价值，有没有被低估？](http://mp.weixin.qq.com/s?__biz=MjM5NTY1MjY0MQ==&mid=2650738494&idx=1&sn=1112eab1d72002fafae9231192325751&chksm=befe9a7089891366060d29dae315dde364436e3815f68ef42b6d5c797eb9c8969e3d47062ce1&scene=21#wechat_redirect)

[Python书单，不将就](http://mp.weixin.qq.com/s?__biz=MjM5NTY1MjY0MQ==&mid=2650737767&idx=1&sn=330b86fcefff1d75b8fe4bbe6d308614&chksm=befe99298989103ff72df995b62fffa1440c771033cfdacc13b72d9b26f4a4260a049da77199&scene=21#wechat_redirect)

[惊呆了！2000行代码搞定特斯拉](http://mp.weixin.qq.com/s?__biz=MjM5NTY1MjY0MQ==&mid=2650737823&idx=1&sn=5f77c0706220a406b4309582e4314b61&chksm=befe99d1898910c753e34582cf7eef71d22cbfaac9cb2778dfc0d5c2fb5e6032f115da505c56&scene=21#wechat_redirect)

[吐血推荐 | Android开发从入门到进阶的十本好书](http://mp.weixin.qq.com/s?__biz=MjM5NTY1MjY0MQ==&mid=2650737641&idx=1&sn=9ac1396ea42e322017eb272874cac335&chksm=befe9ea7898917b131ff615cba964753c57307ecdaf105a81e76579ea94f341afe1d31794408&scene=21#wechat_redirect)
...
*   链接：showme.codes/2017-02-20/understand-https/
